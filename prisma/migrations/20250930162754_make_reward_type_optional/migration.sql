...
INSERT INTO "new_RewardCatalog" ("categoryId", "createdAt", "id", "imageUrl", "isActive", "label", "pointsCost", "type", "updatedAt", "valueCents") SELECT "categoryId", "createdAt", "id", "imageUrl", "isActive", "label", "pointsCost", "type", "updatedAt", "valueCents" FROM "RewardCatalog";
